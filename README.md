...
<p>We've awarded Gold&thinsp;🥇, Silver&thinsp;🥈, and Bronze&thinsp;🥉 medals when merited.&thinsp; We also highlighted configurations that deploy firmware written in <a href="https://docs.emscript.openem.org/"><b>EM&bull;Script</b></a>&thinsp;<img src="docs/images/em-dot.svg" width="16", alt="">&thinsp;&ndash; a novel programming platform under active development and currently available for preview, which targets resource-constrained MCUs.</p>
